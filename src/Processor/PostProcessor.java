...
public class PostProcessor extends Processor {
    ...
    public String process() {
        ...
        if (this.args == null) {
        ...
        } else {                                                           //this function splits it up and does stuff if theres a post ID
            ...
            else if(argName == "userid"){                                  //if argName is userid, search up by user's ID
                int userid = Integer.parseInt(argParts[1]);
                Post post = Post.getPostByUser(userid);
                responseBuilder.setStatus("OK");
                responseBuilder.setData(post);
            }
